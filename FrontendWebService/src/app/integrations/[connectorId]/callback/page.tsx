 ...
 * PUBLIC_INTERFACE
 * OAuthCallbackPage
 * This page handles the OAuth redirect/callback for a connector.
 * It reads query params (e.g., code, state, status, message) and displays a success/error UI.
 * If redirect=true is present, it will auto-redirect back to /integrations with the status/message as banner query params.
 *
 * Query params supported:
 * - code: string (optional; provided by provider during auth code flow)
 * - state: string (recommended by backend; used for CSRF validation)
 * - status: string ("success" | "error" | others; unknown treated as "unknown")
